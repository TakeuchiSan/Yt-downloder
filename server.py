...
<head>
  ...
  <style>
    ...
    .video-card { border: 1px solid #eee; border-radius: 8px; overflow: hidden; background: #fafafa; }
    ...
    .video-author { font-size: 12px; color: #666; margin-bottom: 8px; }
...
<body>
  ...
  <script>
    ...
    async function search() {
      ...
      randomDiv.style.display = 'none'; // sembunyikan saran video saat search
      try {
        ...
        data.forEach(v => {
          ...
          card.innerHTML = `
            ...
            <div class="video-details">
              ...
              <div class="video-author">${v.author}</div>
